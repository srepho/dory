...
```mermaid
xychart-beta
    title "Observability Setup Effort (lower = easier)"
    x-axis [Haystack, LangGraph, "Pydantic AI", "MS Agent", "Claude SDK"]
    y-axis "Effort Level" 0 --> 5
    bar [3, 1, 1, 1, 5]
```
...
```mermaid
xychart-beta
    title "Lines of Code for Same Use Case (lower = simpler)"
    x-axis ["Pydantic AI", Haystack, LangGraph, "MS Agent", "Claude SDK"]
    y-axis "Lines of Code" 0 --> 200
    bar [90, 110, 120, 120, 180]
```
...
```mermaid
xychart-beta
    title "Experiment 1: Success Rate with Scraped Docs (%)"
...
```mermaid
xychart-beta
    title "Experiment 1: Average Turns (lower = easier)"
    x-axis ["Pydantic AI", "Direct API", LangGraph, Haystack]
...
```mermaid
xychart-beta
    title "Experiment 2: Success Rate with Curated Docs (%)"
    x-axis [Haystack, LangGraph, "OpenAI Agents", "Anthropic Agents"]
    y-axis "Success Rate %" 0 --> 100
    bar [100, 100, 100, 92]
```
...
```mermaid
xychart-beta
    title "Experiment 2: Average Turns (lower = easier)"
    x-axis [Haystack, LangGraph, "OpenAI Agents", "Anthropic Agents"]
    y-axis "Avg Turns" 0 --> 6
    bar [1.75, 5.4, 1.65, 2.1]
```
